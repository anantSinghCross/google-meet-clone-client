  ...
  return (
    <>
      {call.isReceivingCall && !callAccepted && (
        <div className="fixed border-2 border-indigo-400 shadow-md shadow-indigo-100 bottom-4 right-4 flex gap-4 p-3 rounded-xl justify-center w-max items-center">
